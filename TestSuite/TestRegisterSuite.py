...
class Test_register(unittest.TestCase):
    ...
    def test_empty_phone(self):
        ...
        self.login.select_deal()
        self.login.register()
        self.assertEqual(self.login.login_error_page(),register_data[4]['except_result'])
    # 不符合规则的手机号
    def test_incongruent_phone(self):
        ...
        self.login.select_deal()
        self.login.register()
        self.assertEqual(self.login.login_error_page(), register_data[5]['except_result'])
    # 6位全英文密码
    def test_incongruent_psw(self):
        ...
        self.login.select_deal()
        self.login.register()
        self.assertEqual(self.login.login_error_page(), register_data[6]['except_result'])
    # 6位全数字的密码
    def test_allnumber_psw(self):
        ...
        self.login.select_deal()
        self.login.register()
        self.assertEqual(self.login.login_error_page(), register_data[7]['except_result'])
    # 小于6位的密码
    def test_less_psw(self):
        ...
        self.login.select_deal()
        self.login.register()
        self.assertEqual(self.login.login_error_page(), register_data[8]['except_result'])
    # 验证码与手机号不匹配
